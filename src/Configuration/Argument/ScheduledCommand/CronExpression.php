 ...
 ***************************************************************/
class CronExpression extends InputArgument implements ArgumentInterface
{
    use Mode;
    const NAME = 'cron-expression';
    const DESCRIPTION = 'Cron expression for command execution time';
