 ...
 ***************************************************************/
class ExecuteImmediately extends InputArgument implements ArgumentInterface
{
    use Mode;
    const NAME = 'execute-immediately';
    const DESCRIPTION = 'Execute scheduled command immediately';
